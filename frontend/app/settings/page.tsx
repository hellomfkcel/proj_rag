              ...
              {typeModels.map(m => (
                <div key={m.model_id}
                  className={`flex items-center justify-between px-4 py-3 rounded-lg border transition ${
                    m.is_default ? "border-blue-300 bg-blue-50" : "border-gray-200 hover:border-gray-300"}`}>
                  ...
                  <div className="flex items-center gap-2">
                    {m.is_default ? (
                      ...
                      <button
                        onClick={() => handleSetDefaultModel(m.model_id)}
                    ...
                    {/* Provider badge */}
                    <span className="text-[10px] bg-gray-50 text-gray-400 px-1.5 py-0.5 rounded border border-gray-100">{m.model_type}</span>
                  </div>
                </div>
              ))}
            </div>
